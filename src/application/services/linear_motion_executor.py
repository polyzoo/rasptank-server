...
class LinearMotionExecutor:
    ...
    def run(self, distance_cm: float, speed_percent: int, move_fn: MoveCommand) -> bool:
        ...
        try:
            while self.lifecycle.should_keep_running():
                ...
                last_effective_speed: float = effective_speed
                last_cmd_speed: float = effective_speed
